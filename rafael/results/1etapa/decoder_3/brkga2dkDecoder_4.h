...
#ifndef BRKGA2DKDECODER_4_H 
#define BRKGA2DKDECODER_4_H
...
class brkga2dkDecoder_4{
public:
	brkga2dkDecoder_4(knapsack2d& instance  );	// Constructor
	~brkga2dkDecoder_4();	// Destructor
