...
#ifndef BRKGA2DKDECODER_3_H 
#define BRKGA2DKDECODER_3_H
...
class brkga2dkDecoder_3{
public:
	brkga2dkDecoder_3(knapsack2d& instance  );	// Constructor
	~brkga2dkDecoder_3();	// Destructor
