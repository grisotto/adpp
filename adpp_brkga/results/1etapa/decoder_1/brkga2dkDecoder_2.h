...
#ifndef BRKGA2DKDECODER_2_H 
#define BRKGA2DKDECODER_2_H
...
class brkga2dkDecoder_2{
public:
	brkga2dkDecoder_2(knapsack2d& instance  );	// Constructor
	~brkga2dkDecoder_2();	// Destructor
